...
with upsert as (
  ...
  values (gen_random_uuid(), (select id from tenants where name = 'Demo Shipping' limit 1), '9999999', 'MV Pioneer', 'US', 'ABS')
...
-- Roles
with base as (
  select (select id from tenants where name = 'Demo Shipping' limit 1) as tenant_id
), r as (
...
where r.tenant_id = (select id from tenants where name = 'Demo Shipping' limit 1) and r.slug = 'admin'
on conflict do nothing;
...
where r.tenant_id = (select id from tenants where name = 'Demo Shipping' limit 1) and r.slug = 'author'
on conflict do nothing;
...
where r.tenant_id = (select id from tenants where name = 'Demo Shipping' limit 1) and r.slug = 'reviewer'
on conflict do nothing;
...
where r.tenant_id = (select id from tenants where name = 'Demo Shipping' limit 1) and r.slug = 'auditor'
on conflict do nothing;
...
select email, id from users where tenant_id = (select id from tenants where name = 'Demo Shipping' limit 1) and email in (
...
select u.id, r.id
from _uids u
join roles r on r.tenant_id = (select id from tenants where name = 'Demo Shipping' limit 1) and (
...
select gen_random_uuid(), (select id from tenants where name = 'Demo Shipping' limit 1), 'system.bootstrap', 'Tenant', (select id from tenants where name = 'Demo Shipping' limit 1), jsonb_build_object('name','Demo Shipping')
on conflict do nothing;

-- ========================
-- Second tenant: Oceanic Logistics (US region)
-- ========================
